...
public interface ApplyDao {
     ...
     * @return
     */
    List<Apply> findMyApplyList(@Param("userId") Long userId, @Param("applyState") Integer applyState);
     ...
     * @return
     */
    List<Apply> findMyHistoryApplyList(@Param("userId") Long userId, @Param("applyState") Integer applyState);
