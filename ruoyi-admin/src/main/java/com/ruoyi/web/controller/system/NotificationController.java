...
public class NotificationController extends BaseController {
    ...
    private String path = "/Users/shenyunyao/Desktop/competition_apply_system-master/file";
    ...
    public @ResponseBody
    ResponseMessage findNotificationByType(Long acuserId) {
        try {
            //获取类型为0（竞赛通知）的数据
            List<Notification> notifications = notificationService.findNotificationByType(0,acuserId);
    ...
    @RequestMapping("/findAuditNotificationByType")
    public @ResponseBody
    ResponseMessage findAuditNotificationByType() {
        try {
            //获取类型为0（竞赛通知）的数据
            List<Notification> notifications = notificationService.findAuditNotificationByType(0);
            System.out.println(notifications);
    ...
    @RequestMapping("/competitionAudit")
    public @ResponseBody
    ResponseMessage competitionAudit(String notificationId,String competitionId,Integer competitionState,Long userId) {
        System.out.println(competitionState);
        System.out.println(userId);
        try {
            notificationService.competitionAudit(notificationId,competitionId,competitionState,userId);
    ...
    insertCompetitionNotification(@RequestBody CompetitionNotificationVO competitionNotificationVO) throws IOException {
        ...
        //默认为比赛审核中
        competition.setCompetitionState(3);
